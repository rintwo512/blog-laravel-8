...
<form action="/dashboard/posts/{{ $post->slug }}" method="post" class="mb-5" enctype="multipart/form-data">
    ...
    <div class="mb-3">
      ...
      <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" id="title" placeholder="Insert Title" value="{{ old('title', $post->title) }}" required autofocus>
      @error('title')
    ...
    <div class="mb-3">
        ...
        <input type="text" name="slug" class="form-control @error('slug') is-invalid @enderror" id="slug" placeholder="Insert Slug" value="{{ old('slug', $post->slug) }}">
        @error('slug')
      <div class="invalid-feedback">
          {{ $message }}
      </div>          
    ...
    <div class="mb-3">
        ...
        <img src="{{ asset('storage/' . $post->img) }}" class="img-preview img-fluid mb-3 col-sm-5 d-block">
